...
contains
  ...
  subroutine EvalAmp_WBFH_UnSymm(i1,i2,i3,i4,vvcoupl,za,zb,sprod,res)
    ...
    complex(dp), intent(in) :: vvcoupl(4), za(4,4), zb(4,4)
  ...
  function A0_VV_4f(j1,j2,j3,j4,vvcoupl,za,zb,sprod,mv,ga_v)
    ...
    a1 = vvcoupl(1) * mv**2/mhsq + vvcoupl(2) * two * q1q2/mhsq + vvcoupl(3) * kcoupl * q1q2/mhsq
    a2 = -two * vvcoupl(2) - kcoupl * vvcoupl(3)
    a3 = -two * vvcoupl(4)
